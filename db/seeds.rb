...
Message.create(body: "How you doin?", user: User.last)
Message.create(body: "Supah", user: User.first)
Message.create(body: "Bye", user: User.last)
Message.create(body: "See you!", user: User.first)